...
@interface PurchaseGameCard ()

@end

@implementation PurchaseGameCard

_INSTANCE_IMPL_(PurchaseGameCard);

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    self.gameCardList = [PurchaseTypeList list:GAMECARD_LIST];
