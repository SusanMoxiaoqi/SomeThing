...
public class FragmentCardZongyou extends FragmentCardBase {
	
	@Override
	public View getCurrentView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		_fragmentBtnId = R.id.card_zongyou;
		return inflater.inflate(R.layout.by_pay_chongzhi_content_zongyou, container,false);
	}
	
	@Override
	public void payNow() {
		BYPMgr.PURCHASE_CARD_CHANNEL = Constants.CardChannel.ZONGYOU;
		super.payNow();
	}
