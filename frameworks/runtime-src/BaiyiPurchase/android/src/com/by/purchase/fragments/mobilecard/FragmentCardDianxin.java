...
public class FragmentCardDianxin extends FragmentCardBase {

	@Override
	public View getCurrentView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		_fragmentBtnId = R.id.card_dianxin;
		return inflater.inflate(R.layout.by_pay_shouji_content_dianxin,
				container, false);
	}

	@Override
	public void payNow() {
		BYPMgr.PURCHASE_CARD_CHANNEL = Constants.CardChannel.DIANXIN;
		super.payNow();
	}
