...
public class FragmentCardWanmei extends FragmentCardBase {
	
	@Override
	public View getCurrentView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		_fragmentBtnId = R.id.card_wanmei;
		return inflater.inflate(R.layout.by_pay_chongzhi_content_wanmei, container,false);
	}
	
	@Override
	public void payNow() {
		BYPMgr.PURCHASE_CARD_CHANNEL = Constants.CardChannel.WANMEI;
		super.payNow();
	}
