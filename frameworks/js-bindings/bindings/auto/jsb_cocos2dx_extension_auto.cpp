...
bool js_cocos2dx_extension_ScrollView_addChildToLayer(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    js_proxy_t *proxy = jsb_get_js_proxy(obj);
    cocos2d::extension::ScrollView* cobj = (cocos2d::extension::ScrollView *)(proxy ? proxy->ptr : NULL);
    JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_extension_ScrollView_addChildToLayer : Invalid Native Object");
    ...
    do {
        if (argc == 3) {
            ...
            if (!ok) { ok = true; break; }
            cobj->addChildToLayer(arg0, arg1, arg2);
            args.rval().setUndefined();
            return true;
        }
    } while(0);
    JS_ReportError(cx, "js_cocos2dx_extension_ScrollView_addChildToLayer : wrong number of arguments");
    return false;
}
...
void js_register_cocos2dx_extension_ScrollView(JSContext *cx, JS::HandleObject global) {
    ...
    static JSFunctionSpec funcs[] = {
        ...
        JS_FN("addChildToLayer", js_cocos2dx_extension_ScrollView_addChildToLayer, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
